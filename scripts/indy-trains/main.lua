...
local function summon_arriving_passenger_train(player_id)
    ...
    local driver = Net.create_bot(driver_id,
        { name = "", area_id = area_id, texture_path = trainProps["Driver Texture"], animation_path = trainProps
        ["Driver Animation"], x = trainProps["startX"], y = trainProps["startY"], z = trainProps["trainZ"], solid = false, warp_in = false })
    local car_id = train.name .. '-car-' .. area_id
    local driver = Net.create_bot(car_id,
        { name = "", area_id = area_id, texture_path = "/server/assets/indy-trains/" .. trainProps["Color"] .. "_car.png", animation_path =
        "/server/assets/indy-trains/" .. trainProps["Color"] .. "_car.animation", x = trainProps["startX"], y =
        trainProps["startY"], z = trainProps["trainZ"], solid = false, warp_in = false })
    local engine_id = train.name .. '-engine-' .. area_id
    local driver = Net.create_bot(engine_id,
        { name = "", area_id = area_id, texture_path = "/server/assets/indy-trains/" .. trainProps["Color"] ..
        "_train.png", animation_path = "/server/assets/indy-trains/" .. trainProps["Color"] .. "_train.animation", x =
        trainProps["startX"], y = trainProps["startY"], z = trainProps["trainZ"], solid = false, warp_in = false })
    ...
    if direction == "DR" or direction == "DL" then
        --spawn pedestal
        local pedestal = Net.create_bot(pedestal_id,
            { name = "", area_id = area_id, texture_path = "/server/assets/indy-trains/pedestal.png", animation_path =
            "/server/assets/indy-trains/pedestal_" .. trainProps["Color"] .. ".animation", x = trainProps["startX"], y =
            trainProps["startY"], z = trainProps["trainZ"], solid = false, warp_in = false })
    end
    ...
    return async(function()
        ...
        if direction == "DR" then
            ...
            keyframes[#keyframes + 1] = { properties = { { property = "Animation", value = "IDLE_" .. direction }, { property = "X", ease = "Out", value = trainProps["stopX"] + 1.5 - .5 + trainProps["offset"] }, { property = "Y", ease = "Out", value = trainProps["stopY"] + 1.35 + trainProps["offset"] } }, duration =
            start_to_stop }
        ...
        elseif direction == "UL" then
            ...
            keyframes[#keyframes + 1] = { properties = { { property = "Animation", value = "IDLE_" .. direction }, { property = "X", ease = "Out", value = trainProps["stopX"] + 2.15 + trainProps["offset"] }, { property = "Y", ease = "Out", value = trainProps["stopY"] + 1.4 + trainProps["offset"] } }, duration =
            start_to_stop }
            Net.animate_player_properties(player_id, keyframes)
        elseif direction == "UR" then
            ...
            keyframes[#keyframes + 1] = { properties = { { property = "Animation", value = "IDLE_" .. direction }, { property = "X", ease = "Out", value = trainProps["stopX"] + 1.4 + trainProps["offset"] }, { property = "Y", ease = "Out", value = trainProps["stopY"] + 2.4 + trainProps["offset"] } }, duration =
            start_to_stop }
            Net.animate_player_properties(player_id, keyframes)
        elseif direction == "DL" then
            ...
            keyframes[#keyframes + 1] = { properties = { { property = "Animation", value = "IDLE_" .. direction }, { property = "X", ease = "Out", value = trainProps["stopX"] + 1.3 + trainProps["offset"] }, { property = "Y", ease = "Out", value = trainProps["stopY"] + 1.05 + trainProps["offset"] } }, duration =
            start_to_stop }
            Net.animate_player_properties(player_id, keyframes)
        end
        ...
        keyframes[#keyframes + 1] = { properties = { { property = "Animation", value = "IDLE_" .. direction }, { property = "X", ease = "Out", value = trainProps["stopX"] + .5 + driver_offset_x }, { property = "Y", ease = "Out", value = trainProps["stopY"] + .5 + driver_offset_y } }, duration =
        start_to_stop }
        ...
        keyframes[#keyframes + 1] = { properties = { { property = "Animation", value = "IDLE_" .. direction }, { property = "X", ease = "Out", value = trainProps["stopX"] + .5 + car_offset_x }, { property = "Y", ease = "Out", value = trainProps["stopY"] + .5 + car_offset_y } }, duration =
        start_to_stop }
        ...
        keyframes[#keyframes + 1] = { properties = { { property = "Animation", value = "IDLE_" .. direction }, { property = "X", ease = "Out", value = trainProps["stopX"] + .5 + train_offset_x }, { property = "Y", ease = "Out", value = trainProps["stopY"] + .5 + train_offset_y } }, duration =
        start_to_stop }
        ...
        if direction == "DR" or direction == "DL" then
            ...
            keyframes[#keyframes + 1] = { properties = { { property = "Animation", value = "IDLE_" .. direction }, { property = "X", ease = "Out", value = trainProps["stopX"] + .5 + pedestal_offset_x }, { property = "Y", ease = "Out", value = trainProps["stopY"] + .5 + pedestal_offset_y } }, duration =
            start_to_stop }
        ...
        local lightpath = Net.create_bot(lightpath_id,
            { name = "", area_id = area_id, texture_path = "/server/assets/indy-trains/lightpath.png", animation_path =
            "/server/assets/indy-trains/lightpath_" .. trainProps["Color"] .. ".animation", x = trainProps["stopX"] + .5 +
            light_offset_x, y = trainProps["stopY"] + .5 + light_offset_y, z = trainProps["trainZ"], solid = false, warp_in = false })
        ...
        keyframes[#keyframes + 1] = { properties = { { property = "Animation", value = "IDLE_" .. direction }, { property = "X", ease = "In", value = trainProps["endX"] + .5 + driver_offset_x }, { property = "Y", ease = "In", value = trainProps["endY"] + .5 + driver_offset_y } }, duration =
        stop_to_end }
        ...
        keyframes[#keyframes + 1] = { properties = { { property = "Animation", value = "IDLE_" .. direction }, { property = "X", ease = "In", value = trainProps["endX"] + .5 + car_offset_x }, { property = "Y", ease = "In", value = trainProps["endY"] + .5 + car_offset_y } }, duration =
        stop_to_end }
        keyframes[#keyframes + 1] = { properties = { { property = "Animation", value = "IDLE_" .. direction }, { property = "X", ease = "In", value = trainProps["endX"] + .5 + train_offset_x }, { property = "Y", ease = "In", value = trainProps["endY"] + .5 + train_offset_y } }, duration = 1.5 }
        Net.animate_bot_properties(car_id, keyframes)
        ...
        keyframes[#keyframes + 1] = { properties = { { property = "Animation", value = "IDLE_" .. direction }, { property = "X", ease = "In", value = trainProps["endX"] + .5 + train_offset_x }, { property = "Y", ease = "In", value = trainProps["endY"] + .5 + train_offset_y } }, duration =
        stop_to_end }
        keyframes[#keyframes + 1] = { properties = { { property = "Animation", value = "IDLE_" .. direction }, { property = "X", ease = "In", value = trainProps["endX"] + .5 + train_offset_x }, { property = "Y", ease = "In", value = trainProps["endY"] + .5 + train_offset_y } }, duration = 1.5 }
        ...
        if direction == "DR" or direction == "DL" then
            ...
            keyframes[#keyframes + 1] = { properties = { { property = "Animation", value = "IDLE_" .. direction }, { property = "X", ease = "In", value = trainProps["endX"] + .5 + pedestal_offset_x }, { property = "Y", ease = "In", value = trainProps["endY"] + .5 + pedestal_offset_y } }, duration =
            stop_to_end }
...
local function summon_departing_passenger_train(player_id, post_id)
    ...
    if destination_type == "message" then
        ...
        Net.message_player(player_id, destination_id, conductor.custom_properties["Mug Texture"],
            conductor.custom_properties["Mug Animation"])
        return false
    end
    ...
    if track_cache[area_id][train_name]['occupied'] ~= true then
        ...
        return async(function()
            ...
            local car_id = train.name .. '-car-' .. area_id
            local driver = Net.create_bot(car_id,
                { name = "", area_id = area_id, texture_path = "/server/assets/indy-trains/" ..
                trainProps["Color"] .. "_car.png", animation_path = "/server/assets/indy-trains/" ..
                trainProps["Color"] .. "_car.animation", x = trainProps["startX"], y = trainProps["startY"], z =
                trainProps["trainZ"], solid = false, warp_in = false })
            local engine_id = train.name .. '-engine-' .. area_id
            local driver = Net.create_bot(engine_id,
                { name = "", area_id = area_id, texture_path = "/server/assets/indy-trains/" ..
                trainProps["Color"] .. "_train.png", animation_path = "/server/assets/indy-trains/" ..
                trainProps["Color"] .. "_train.animation", x = trainProps["startX"], y = trainProps["startY"], z =
                trainProps["trainZ"], solid = false, warp_in = false })
            local pedestal_id = train.name .. '-pedestal-' .. area_id

            if direction == "DR" or direction == "DL" then
                pedestal = Net.create_bot(pedestal_id,
                    { name = "", area_id = area_id, texture_path = "/server/assets/indy-trains/pedestal.png", animation_path =
                    "/server/assets/indy-trains/pedestal_" .. trainProps["Color"] .. ".animation", x = trainProps
                    ["startX"], y = trainProps["startY"], z = trainProps["trainZ"], solid = false, warp_in = false })
            end
            ...
            local lightpath = Net.create_bot(lightpath_id,
                { name = "", area_id = area_id, texture_path = "/server/assets/indy-trains/lightpath.png", animation_path =
                "/server/assets/indy-trains/lightpath_" .. trainProps["Color"] .. ".animation", x = trainProps["stopX"] +
                .5 + light_offset_x, y = trainProps["stopY"] + .5 + light_offset_y, z = trainProps["trainZ"], solid = false, warp_in = false })
            ...
            if direction == "DR" then --DONE
                ...
                keyframes[#keyframes + 1] = { properties = { { property = "Animation", value = "IDLE_" .. direction }, { property = "X", ease = "In", value = trainProps["endX"] + 1.5 - .5 + trainProps["offset"] }, { property = "Y", ease = "In", value = trainProps["endY"] + 1.35 + trainProps["offset"] } }, duration =
                stop_to_end }
                Net.animate_player_properties(player_id, keyframes)
            elseif direction == "UL" then --DONE
                ...
                keyframes[#keyframes + 1] = { properties = { { property = "Animation", value = "IDLE_" .. direction }, { property = "X", ease = "In", value = trainProps["endX"] + 2.15 + trainProps["offset"] }, { property = "Y", ease = "In", value = trainProps["endY"] + 1.4 + trainProps["offset"] } }, duration =
                stop_to_end }
                Net.animate_player_properties(player_id, keyframes)
            elseif direction == "UR" then
                --Animation for Player Boarding Train
                ...
                keyframes[#keyframes + 1] = { properties = { { property = "Animation", value = "IDLE_" .. direction }, { property = "X", ease = "In", value = trainProps["endX"] + 1.4 + trainProps["offset"] }, { property = "Y", ease = "In", value = trainProps["endY"] + 2.4 + trainProps["offset"] } }, duration =
                stop_to_end }
                Net.animate_player_properties(player_id, keyframes)
            elseif direction == "DL" then
                --Animation for Player Boarding Train
                ...
                keyframes[#keyframes + 1] = { properties = { { property = "Animation", value = "IDLE_" .. direction }, { property = "X", ease = "In", value = trainProps["endX"] + 1.3 + trainProps["offset"] }, { property = "Y", ease = "In", value = trainProps["endY"] + 1.05 + trainProps["offset"] } }, duration =
                stop_to_end }
                Net.animate_player_properties(player_id, keyframes)
            end
            ...
            Net.move_bot(engine_id, trainProps["endY"] + .5 + train_offset_x, trainProps["endY"] + .5 + train_offset_y,
                trainProps["Train Z"])
            Net.move_bot(driver_id, trainProps["endX"] + .5 + driver_offset_x, trainProps["endY"] + .5 + driver_offset_y,
                trainProps["Train Z"])
            Net.move_bot(car_id, trainProps["endX"] + .5 + car_offset_x, trainProps["endY"] + .5 + car_offset_y,
                trainProps["Train Z"])
            if direction == "DR" or direction == "DL" then
                Net.move_bot(car_id, trainProps["endX"] + .5 + pedestal_offset_x, trainProps["endY"] + .5 +
                pedestal_offset_y, trainProps["Train Z"])
            end
            ...
            if destination_type == "area" then
                ...
                if direction == "DR" then
                    Net.transfer_player(player_id, destination_id, false, destination_trainProps["startX"] + 1,
                        destination_trainProps["startY"] + 1.5, destination_trainProps["platformZ"], direction)
                elseif direction == "UL" then
                    Net.transfer_player(player_id, destination_id, false, destination_trainProps["startX"] + 2.15,
                        destination_trainProps["startY"] + 1.4, destination_trainProps["platformZ"], direction)
                elseif direction == "UR" then
                    Net.transfer_player(player_id, destination_id, false, destination_trainProps["startX"] + 1.4,
                        destination_trainProps["startY"] + 2.4, destination_trainProps["platformZ"], direction)
                elseif direction == "DL" then
                    Net.transfer_player(player_id, destination_id, false, destination_trainProps["startX"] + 1.3,
                        destination_trainProps["startY"] + 1.05, destination_trainProps["platformZ"], direction)
                end
                ...
                Net.transfer_server(player_id, server_parts[1], server_parts[2], false,
                    "trains__" .. server_area .. "__" .. server_train)
            end
        end)
    else
        local conductor = conductor_cache[area_id]['conductor-' .. train.name .. '-' .. area_id]
        Net.message_player(player_id, "Another train is on the track, please wait for further traffic clearance.",
            conductor.custom_properties["Mug Texture"], conductor.custom_properties["Mug Animation"])
    end
end
...
local function validate_passenger_train(area_id, train_name)
    ...
    for i, prop_name in pairs(passenger_train_required_properties) do
        if not train.custom_properties[prop_name] then
            print('   Train \'' ..
            train.name .. '\' was not created because the custom property ' .. prop_name .. ' is required.')
            train.remove()
            return false
        else
...
local function greet_conductor(bot_id, player_id)
    return async(function()
        ...
        if track_cache[area_id][train_name]['occupied'] == true then
            local conductor = conductor_cache[area_id]['conductor-' .. train_name .. '-' .. area_id]
            Net.message_player(player_id, "Another train is on the track, please wait for further traffic clearance.",
                conductorProps["Mug Texture"], conductorProps["Mug Animation"])
            return false
        end
        Net.lock_player_input(player_id)
...
local function spawn_conductor(area_id, object_data)
    ...
    for i, prop_name in pairs(conductor_required_properties) do
        if not conductor.custom_properties[prop_name] then
            print('   Conductor for \'' ..
            conductor.custom_properties["Train"] ..
            '\' was not created in ' .. area_id .. ' because the custom property ' .. prop_name .. ' is required.')
            conductor.remove()
            return false
        else
    ...
    --spawn bot
    Net.create_bot(conductor_name,
        { name = "", area_id = area_id, texture_path = conductor.custom_properties["Texture"], animation_path = conductor
        .custom_properties["Animation"], x = conductor.x, animation = "IDLE_" .. conductor_direction, y = conductor.y, z =
        conductor.z, solid = true, warp_in = false })
end
...
local function validate_cargo_train(area_id, train_name)
    ...
    local driver_id = train.name .. '-driver-' .. area_id
    local driver = Net.create_bot(driver_id,
        { name = "", area_id = area_id, texture_path = train.custom_properties["Driver Texture"], animation_path = train
        .custom_properties["Driver Animation"], x = startX, y = startY, z = trainZ, solid = false, warp_in = false })
    local car_id = train.name .. '-car-' .. area_id
    local driver = Net.create_bot(car_id,
        { name = "", area_id = area_id, texture_path = "/server/assets/indy-trains/" ..
        train.custom_properties["Color"] .. "_car.png", animation_path = "/server/assets/indy-trains/" ..
        train.custom_properties["Color"] .. "_car.animation", x = startX, y = startY, z = trainZ, solid = false, warp_in = false })
    local engine_id = train.name .. '-engine-' .. area_id
    local driver = Net.create_bot(engine_id,
        { name = "", area_id = area_id, texture_path = "/server/assets/indy-trains/" ..
        train.custom_properties["Color"] .. "_train.png", animation_path = "/server/assets/indy-trains/" ..
        train.custom_properties["Color"] .. "_train.animation", x = startX, y = startY, z = trainZ, solid = false, warp_in = false })
...
local function run_cargo_train(area_id, train_name)
    ...
    keyframes[#keyframes + 1] = { properties = { { property = "Animation", value = "IDLE_" .. direction }, { property = "X", ease = "Linear", value = trainProps["endX"] + .5 + driver_offset_x }, { property = "Y", ease = "Linear", value = trainProps["endY"] + .5 + driver_offset_y } }, duration =
    duration }
    Net.animate_bot_properties(driver_id, keyframes)
    local car_id = train.name .. '-car-' .. area_id
    ...
    keyframes[#keyframes + 1] = { properties = { { property = "Animation", value = "IDLE_" .. direction }, { property = "X", ease = "Linear", value = trainProps["endX"] + .5 + car_offset_x }, { property = "Y", ease = "Linear", value = trainProps["endY"] + .5 + car_offset_y } }, duration =
    duration }
    Net.animate_bot_properties(car_id, keyframes)
    local engine_id = train.name .. '-engine-' .. area_id
    ...
    keyframes[#keyframes + 1] = { properties = { { property = "Animation", value = "IDLE_" .. direction }, { property = "X", ease = "Linear", value = trainProps["endX"] + .5 + train_offset_x }, { property = "Y", ease = "Linear", value = trainProps["endY"] + .5 + train_offset_y } }, duration =
    duration }
    Net.animate_bot_properties(engine_id, keyframes)
    ...
    if event.data ~= "" then
        ...
        if string.find(event.data, "trains__") then
            ...
            if train_cache[destination_area][train_name] then
                ...
                Net.transfer_player(event.player_id, destination_area, false, destination_trainProps["startX"] + 1,
                    destination_trainProps["startY"] + 1.5, destination_trainProps["platformZ"], direction)
